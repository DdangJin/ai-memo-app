        ...
        >
          {user && (
            <div className="flex items-center space-x-2 bg-white/40 dark:bg-slate-800/40 backdrop-blur-sm rounded-2xl p-2 border border-white/20 dark:border-slate-700/30 shadow-lg">
              ...
              <Link
                href="/voice-test"
                className="group relative px-4 py-2 text-slate-700 dark:text-slate-300 hover:text-green-600 dark:hover:text-green-400 focus:outline-none focus:ring-4 focus:ring-green-500/25 rounded-xl transition-all duration-300 hover:bg-white/60 dark:hover:bg-slate-700/60"
              >
                <span className="relative flex items-center gap-2">
                  <svg
                    className="w-4 h-4 group-hover:scale-110 transition-transform"
